          ...
          <SignUp
            appearance={{
              elements: {
                ...
                formFieldInput: 'bg-[oklch(0.15_0.02_270_/_0.6)] border-[oklch(0.40_0.05_270_/_0.3)] text-[oklch(0.95_0.01_270)]',
                formButtonPrimary: 'bg-[oklch(0.65_0.25_270)] hover:bg-[oklch(0.70_0.28_270)]',
                footerActionLink: 'text-[oklch(0.65_0.25_270)]',
              },
            }}
          />
        </div>
